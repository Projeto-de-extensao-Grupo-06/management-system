...
export default function GeneralInfoForm({
  ...
  const [coworkerSelectOptions, setCoworkersSelectOptions] = useState<
      ...
      <div className={styles.form}>
        ...
        <div className={styles.inputContainer}>
          ...
          <AutoCompleteSelect
            ...
            value={
              projectStatusOptions.find((o) => o.value === project.status) ??
              null
            }
          />
        </div>
        ...
        <div className={styles.inputContainer}>
          ...
          >
            {projectSystemTypeOptions.map((v, key) => (
              <SelectOption label={v.label} value={v.value} key={key} />
            ))}
          </Select>
        </div>
